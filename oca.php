 ...
 * OCA PHP API Class
 *
 * @link https://github.com/ContextusLA/OCA-PHP-API
 * @version 0.1.1
 */
...
{
    const VERSION = '0.1.1';
    protected $webserviceUrl = 'webservice.oca.com.ar';
     ...
     * @return void
     */
    public function setCurlOptArr($curlArr)
    {
        $this->curlOptArr = $curlArr;
    }
    ...
    {
        return 'OCA-PHP-API ' . self::VERSION . ' - github.com/ContextusLA/OCA-PHP-API';
    }
    ...
    public function tarifarEnvioCorporativo(
        ...
        $curl_opt_arr[CURLOPT_URL] = "{$this->webserviceUrl}/epak_tracking/Oep_TrackEPak.asmx/Tarifar_Envio_Corporativo";
    ...
    public function listEnvios($fechaDesde, $fechaHasta)
    {
        ...
        $curl_opt_arr[CURLOPT_POST] = true;
        $curl_opt_arr[CURLOPT_POSTFIELDS] = http_build_query($_query_string);
        $curl_opt_arr[CURLOPT_URL] = "{$this->webserviceUrl}/epak_tracking/Oep_TrackEPak.asmx/List_Envios";
    ...
    public function trackingPieza($pieza = '', $nroDocumentoCliente = '')
    {
        ...
        $curl_opt_arr[CURLOPT_POST] = true;
        $curl_opt_arr[CURLOPT_POSTFIELDS] = http_build_query($_query_string);
        $curl_opt_arr[CURLOPT_URL] = "{$this->webserviceUrl}/epak_tracking/Oep_TrackEPak.asmx/Tracking_Pieza";
    ...
    public function getCentrosImposicionPorCP($CP = null)
    {
        ...
        $curl_opt_arr[CURLOPT_POST] = true;
        $curl_opt_arr[CURLOPT_POSTFIELDS] = http_build_query($_query_string);
        $curl_opt_arr[CURLOPT_URL] = "{$this->webserviceUrl}/oep_tracking/Oep_Track.asmx/GetCentrosImposicionPorCP";
    ...
    public function getCentrosImposicion()
    {
        ...
        $curl_opt_arr = $this->getCurlOptsArr();
        $curl_opt_arr[CURLOPT_URL] = "{$this->webserviceUrl}/oep_tracking/Oep_Track.asmx/GetCentrosImposicion";
    ...
    public function getProvincias()
    {
        ...
        $curl_opt_arr = $this->getCurlOptsArr();
        $curl_opt_arr[CURLOPT_URL] = "{$this->webserviceUrl}/oep_tracking/Oep_Track.asmx/GetProvincias";
    ...
    public function getLocalidadesByProvincia($idProvincia)
    {
        ...
        // $curl_opt_arr[CURLOPT_POST] 		= true;
        $curl_opt_arr[CURLOPT_POSTFIELDS] = http_build_query($_query_string);
        $curl_opt_arr[CURLOPT_URL] = "{$this->webserviceUrl}/oep_tracking/Oep_Track.asmx/GetLocalidadesByProvincia";
     ...
     */
    public function ingresoOR(
        $usuarioEPack,
        $passwordEPack,
        $xmlRetiro,
        $confirmarRetiro = false,
        $diasRetiro = 1,
        $franjaHoraria = Oca::FRANJA_HORARIA_8_17HS
    ) {
        $_query_string = [
            'usr' => $usuarioEPack,
            'psw' => $passwordEPack,
        ...
        // $curl_opt_arr[CURLOPT_POST] 		= true;
        $curl_opt_arr[CURLOPT_POSTFIELDS] = http_build_query($_query_string);
        $curl_opt_arr[CURLOPT_URL] = "{$this->webserviceUrl}/oep_tracking/Oep_Track.asmx/IngresoOR";
    ...
    public function ingresoORMultiplesRetiros($usuarioEPack, $passwordEPack, $xmlDatos, $confirmarRetiro = false)
    {
        ...
        // $curl_opt_arr[CURLOPT_POST] 		= true;
        $curl_opt_arr[CURLOPT_POSTFIELDS] = http_build_query($_query_string);
        $curl_opt_arr[CURLOPT_URL] = "{$this->webserviceUrl}/epak_tracking/Oep_TrackEPak.asmx/IngresoORMultiplesRetiros";
    ...
    public function getCentroCostoPorOperativa($cuit, $operativa)
    {
        ...
        // $curl_opt_arr[CURLOPT_POST] 		= true;
        $curl_opt_arr[CURLOPT_POSTFIELDS] = http_build_query($_query_string);
        $curl_opt_arr[CURLOPT_URL] = "{$this->webserviceUrl}/oep_tracking/Oep_Track.asmx/GetCentroCostoPorOperativa";
    ...
    public function anularOrdenGenerada($user, $pass, $IdOrdenRetiro)
    {
        ...
        // $curl_opt_arr[CURLOPT_POST] 		= true;
        $curl_opt_arr[CURLOPT_POSTFIELDS] = http_build_query($_query_string);
        $curl_opt_arr[CURLOPT_URL] = "{$this->webserviceUrl}/epak_tracking/Oep_TrackEPak.asmx/AnularOrdenGenerada";
    ...
    public function getHtmlDeEtiquetasPorOrdenOrNumeroEnvio($IdOrdenRetiro, $NroEnvio = '')
    {
        ...
        // $curl_opt_arr[CURLOPT_POST] 		= true;
        $curl_opt_arr[CURLOPT_POSTFIELDS] = http_build_query($_query_string);
        $curl_opt_arr[CURLOPT_URL] = "{$this->webserviceUrl}/oep_tracking/Oep_Track.asmx/GetHtmlDeEtiquetasPorOrdenOrNumeroEnvio";
    ...
    public function getPDFDeEtiquetasPorOrdenOrNumeroEnvio($IdOrdenRetiro, $NroEnvio = '', $LogisticaInversa = false)
    {
        ...
        // $curl_opt_arr[CURLOPT_POST] 		= true;
        $curl_opt_arr[CURLOPT_POSTFIELDS] = http_build_query($_query_string);
        $curl_opt_arr[CURLOPT_URL] = "{$this->webserviceUrl}/oep_tracking/Oep_Track.asmx/GetPDFDeEtiquetasPorOrdenOrNumeroEnvio";
